...
class Door extends GameObject {
    constructor(x, y, width = 30, height = 50, levelName, enabled, renderType = GameObject.RENDER_TYPES.COLOR, renderString = { doorColor: "BROWN", knobColor: "YELLOW" }) {
        super(x, y, width, height, GameObject.COLLIDE_STATES.TRIGGER, renderType, renderString);
...
class Player extends GameObject {
    ...
    #handleMovement() {
        ...
        if (this.jumpKeyDown && !this.collidingAbove) {
            ...
            else if (this.doubleJumpEnabled && !this.doubleJumped && this.jumpKeyCount >= 1 && !(this.wallJumpEnabled && (this.collidingRight || this.collidingLeft))) {
                this.yVelocity = this.jumpHeight;
